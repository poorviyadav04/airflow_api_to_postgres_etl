...
## Project Background
This project was built as part of a guided learning exercise and extended
to reinforce my understanding of Apache Airflow, ETL orchestration,
and Docker-based data pipelines.
